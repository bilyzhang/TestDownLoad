...
public class SecurityUtil {
    ...
    public static byte[] encryptHttpBody(String body) {
        return Base64.encodeBase64(
        		new Crypter().encrypt(Utils.getUTF8Bytes(body), SECRET_KEY_HTTP));
    }
	...
	public static byte[] encryptHttpChargePalipayBody(String body) {
		return Base64.encodeBase64(new Crypter().encrypt(Utils.getUTF8Bytes(body), SECRET_KEY_HTTP_CHARGE_ALIPAY));
	}
