...
import static com.example.session.SessionManager.P_CARD_VERSION;
import static com.example.session.SessionManager.P_CLEAR_CACHE;
import static com.example.session.SessionManager.P_CURRENT_VERSION;
import static com.example.session.SessionManager.P_DEFAULT_CHARGE_TYPE;
import static com.example.session.SessionManager.P_ISLOGIN;
import static com.example.session.SessionManager.P_LPNS_BINDED_DEVID;
import static com.example.session.SessionManager.P_LPNS_IS_BINDED;
import static com.example.session.SessionManager.P_MARKET_PASSWORD;
import static com.example.session.SessionManager.P_MARKET_USERNAME;
import static com.example.session.SessionManager.P_PRODUCT_UPDATE_CHECK_TIMESTAMP;
import static com.example.session.SessionManager.P_SCREEN_SIZE;
import static com.example.session.SessionManager.P_SPLASH_ID;
import static com.example.session.SessionManager.P_SPLASH_TIME;
import static com.example.session.SessionManager.P_UID;
import static com.example.session.SessionManager.P_UPDATE_AVAILABIE;
import static com.example.session.SessionManager.P_UPDATE_DESC;
import static com.example.session.SessionManager.P_UPDATE_ID;
import static com.example.session.SessionManager.P_UPDATE_LEVEL;
import static com.example.session.SessionManager.P_UPDATE_URI;
import static com.example.session.SessionManager.P_UPDATE_VERSION_CODE;
import static com.example.session.SessionManager.P_UPDATE_VERSION_NAME;
import static com.example.session.SessionManager.P_UPGRADE_NUM;
...
import com.example.download.DownloadManager.Impl;
    ...
    private void startQuery() {
        ...
        refreshTask.startQuery(DbStatusRefreshTask.DOWNLOAD, null,
                DownloadManager.Impl.CONTENT_URI, null, "(((" + DownloadManager.Impl.COLUMN_STATUS
                        ...
                        + com.example.download.Constants.MIMETYPE_APK + "')", null, null);
 ...
 /*   void refreshDownloadApp(Cursor cursor) {
        ...
        for (cursor.moveToFirst(); !cursor.isAfterLast(); cursor.moveToNext()) {
            ...
            if (DownloadManager.Impl.isStatusRunning(infoItem.mStatus)) {
                ...
                // 下载等待�?                infoItem.mProgressLevel = Constants.STATUS_PENDING;
                ...
                // 用户取消下载，恢复原始状�?                Utils.D("session cancel download " + infoItem.mAppName + " " + infoItem.mStatus);
